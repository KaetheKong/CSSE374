...
public class MixedComplexTesting extends ComplexSprite{

	public MixedComplexTesting(double x, double y, double width, double height) {
		super(x, y, width, height);
		ISprite ts = new TowerSprite(x, y, width, height);
